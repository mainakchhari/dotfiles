...
# The theme to use.
export TMUX_POWERLINE_THEME="monokai"
...
export TMUX_POWERLINE_STATUS_RIGHT_LENGTH="10"
...
export TMUX_POWERLINE_SEG_AIR_DATA_PROVIDER="disabled"
...
export TMUX_POWERLINE_SEG_MODE_INDICATOR_NORMAL_MODE_TEXT="NORM"
...
export TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT="PREF"
export TMUX_POWERLINE_SEG_MODE_INDICATOR_PREFIX_MODE_TEXT_COLOR="#b4d273"
...
export TMUX_POWERLINE_SEG_MODE_INDICATOR_MOUSE_MODE_TEXT="MOUS"
export TMUX_POWERLINE_SEG_MODE_INDICATOR_MOUSE_MODE_TEXT_COLOR="#6c99bb"
...
export TMUX_POWERLINE_SEG_MODE_INDICATOR_COPY_MODE_TEXT_COLOR="#e5b567"
# Suspend mode text & color overrides. Defaults to "SUSPEND" & the segment foreground color set in the theme used.
export TMUX_POWERLINE_SEG_MODE_INDICATOR_SUSPEND_MODE_TEXT="SUSP"
export TMUX_POWERLINE_SEG_MODE_INDICATOR_SUSPEND_MODE_TEXT_COLOR="#e87d3e"
